...
<template>
    <div class="flex gap-8 flex-col lg:flex-row items-center">
        ...
        <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl flex flex-col items-center gap-10 justify-between shadow-lg">
            ...
            <div class="flex flex-col-reverse md:flex-row gap-4">
                <div @click="stopExercise" class="text-white cursor-pointer bg-gray-500 px-6 py-2 rounded-lg hover:bg-gray-600">Stop the Exercise</div>
                <div @click="gotoNextSet" class="text-white cursor-pointer bg-emerald-600 px-6 py-2 rounded-lg hover:bg-emerald-700 disabled">Next Set</div>
            </div>
        </div>
    </div>
</template>