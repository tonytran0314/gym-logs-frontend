...
<template>
    <div class="flex flex-wrap justify-center gap-6 h-80">
      <div v-for="muscle in exercise.muscles" :key="muscle.id" @click="selectMuscle" :data-muscle-id="muscle.id" class="w-40 h-[160px] bg-white text-gray-900 dark:text-blue-50 dark:bg-gray-800 rounded-xl py-6 px-10 hover:cursor-pointer hover:bg-emerald-500 hover:text-white dark:hover:bg-emerald-600 flex flex-col items-center justify-center gap-3">
        <div>
